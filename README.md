...
* [Vavr](https://www.vavr.io) - Functional component library built for Java 8+ that provides persistent data types and functional control structures. [Javaslang Changes Name to Vavr](http://blog.vavr.io/javaslang-changes-name-to-vavr)
